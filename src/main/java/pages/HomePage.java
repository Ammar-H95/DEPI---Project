...
public class HomePage extends PageBase {
	...
	// Single Responsibility Principal: Each page object should only handle elements
	// and actions related to that specific page.
	// Ensure that any shared functionality (e.g., scrolling) is abstracted out to
	// avoid redundancy.

	// Locators as constants to avoid hard coded in case it's going to be changed in
	// the future
	...
	// Used try and catch for expecting predicting any error might happen during
	// like timeout or cannot locate the element
